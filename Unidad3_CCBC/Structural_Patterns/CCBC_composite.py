...
class Child(Component): #Inherits form the abstract class, Component
    """Concrete class"""
...
class Composite(): #Inherits from the abstract class, Component
    ...
    def component_function(self):
        ...
        #Interate through the child objects and  invoke their component function printing their names
...
#Add the submenu 2 that is not a composite
